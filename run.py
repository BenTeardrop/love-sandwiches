...
def get_sales_data():
    ...
    terminal,which must be a string of 6 numbers separated bys commas.
    The loop will repeately request data until it is valid.
    """
    while True:
...
def update_worksheet(data, worksheet):
    ...
    Update the relevant worksheet with the data prvided
    """
...
def get_last_five_entry_sales():
    ...
    collecting the last five entries for each sandwich and
